...
{
    internal class CreateImageHandler : IHandler<CreateImagesCommand>
    {
        
        private readonly IRepository<Image> _imagesRepository;
        private readonly IAppImageService _appImageService;
        public CreateImageHandler(IRepository<Image> imagesRepository, IAppImageService appImageService)
        {
